                    ...
                    <section class="entry-box standard-post">
                        ...
                        <div class="entry-content clearfix">
                            ...
                            <div style="justify-content: center; text-align:center;">
                                ...
                                <?php if ($result['lg'] <> '') { ?>
                                    <a class="punica-button red-button big-button buttonHup" href="https://www.thannam.net/champ/match_lg.php?lg=<?= $result['lg'] ?>&match_id=<?= $_GET['id'] ?>"><i class="fa-solid fa-computer"></i> &nbsp; RANKING SCORE</a>
                                <?php } ?>
                            </div>
                            ...
                            <?php
                                    ...
                                    $NumE = $db->query("SELECT count(id) from thannam_champion_mann WHERE classA = 'E' AND match1='$match'")->fetchColumn();
                                    ...
                                    $AllNUM = $NumA + $NumB + $NumC + $NumD + $NumE + $NumSP + $NumKP + $NumPS + ($NumKTEAM / 3) + $NumVR
                                        + $NumH + $NumFH + $NumFW;
                            ?>
                            ...
                            <div class="showCard">
                                ...
                                <?php if ($result['classe'] == 1) { ?>
                                    <div class="boxA">
                                        <span>CLASS E</span>
                                        <button class="btnA" onclick="location.href='../../champ/?match=<?= $match ?>&classA=E'"><?php echo $NumE; ?></button>
                                    </div>
                                <?php } ?>
                                ...
                                <?php if ($result['hap'] == 1) { ?>
                                    ...
                                    <div class="boxA">
                                        <span>F HAND</span>
                                        <button class="btnA" onclick="location.href='../../champ/form.php?match=<?= $match ?>'" style="background-color: #ff1a1a;"><?php echo $NumFH; ?></button>
                                    </div>
                                    <div class="boxA">
                                        <span>F WEAP</span>
                                        <button class="btnA" onclick="location.href='../../champ/form.php?match=<?= $match ?>'" style="background-color: #ff1a1a;"><?php echo $NumFW; ?></button>
                                    </div>
                                <?php } ?>
                                ...
                                ?>
                                    ...
                                    <?php for ($x = 1; $x <= $result['downloadB']; $x++) { ?>
                                        <div class="boxAA4">
                                            <a href="../../champNav2/bout_chart.php?match=<?= $match ?>&court=<?= $course2[$x]; ?>">
                                                สนาม <button class="btnB btnA"><?= $course2[$x]; ?></button>
                                            </a>
                                        </div>
                                    <?php } ?>
